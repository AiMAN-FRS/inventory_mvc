    ...
    <style>
        ...
        td:nth-child(12) {
            background-color: #90e0ef; /* Warna Biru */
        }
    </style>
    
<main>
    <div class="container-fluid">
        <h1 class="mt-4 mb-4">OVER STOCK</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active"><a href="<?= base_url('dashboard'); ?>">Stock Barang</a></li>
            <li class="breadcrumb-item active" aria-current="page">Over Stock</li>
        </ol>
        <div class="card mb-4">
            <div class="card-header">
                <!-- Button to Open the Modal -->
                <a href="<?= base_url('export/export_over'); ?>" target="_blank" class="btn btn-info">
                    <i class="fa-solid fa-file-arrow-down"></i> Export Data
                </a>
            </div>
            <div class="card-body">
                <div class="alert alert-primary mb-4" role="alert">
                    <b>INFO!</b> Berikut adalah daftar stock barang dalam status <b>"OVER"</b>.
                </div>
                <div class="table-responsive">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <?php  $i = 1; foreach ($stock_over as $barang): ?>
                                <?php if ($barang->stock > $barang->max_stock): ?>
                                <tr>
                                    <td><?= $i++; ?></td>
