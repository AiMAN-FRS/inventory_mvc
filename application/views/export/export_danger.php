...
<head>
	<title>Daftar Stock Barang (Danger)</title>
    ...
    <style>
        ...
        td:nth-child(12) {
            background-color: #f4c4cc !important; /* Warna Merah */
        }
    </style>
...
<body>
	<div class="container">
		<h2>Stock Barang (Danger Stock)</h2>
		<h4>(Stock App)</h4>
		...
		<div class="data-tables datatable-dark">
			<table class="table table-bordered" id="dataTable2" width="100%" cellspacing="0">
				...
				<tbody>
					<?php $i=1; foreach($stock_danger as $data): ?>
						<?php if ($data->stock < 1 || $data->stock < ($data->min_stock / 2)): ?>
                            <tr>
                            	<td><?= $i++; ?></td>
