...
<head>
	<title>Daftar Stock Barang (Warning)</title>
    ...
    <style>
        ...
        td:nth-child(12) {
            background-color: yellow !important; /* Warna Merah */
        }
    </style>
...
<body>
	<div class="container">
		<h2>Stock Barang (Warning Stock)</h2>
		<h4>(Stock App)</h4>
		...
		<div class="data-tables datatable-dark">
			<table class="table table-bordered" id="dataTable2" width="100%" cellspacing="0">
				...
				<tbody>
					<?php $i=1; foreach($stock_warning as $data): ?>
						<?php if ($data->stock < $data->min_stock || $data->stock == $data->min_stock): ?>
                            <tr>
                            	<td><?= $i++; ?></td>
