	...
	<div class="container">
		...
		<div class="row mt-3">
			<div class="col">
				<form method="post" class="form-inline">
					...
					<input type="date" name="tgl_mulaiklr" class="form-control ml-2 mr-3">
					<label for="tglAwal">Tanggal Akhir:</label>
					<input type="date" name="tgl_selesaiklr" class="form-control ml-2 mr-3">
					...
					<button type="submit" name="filter_klr" class="btn btn-danger mt-3">
						<i class="fa-solid fa-sort"></i> Filter Data Keluar
					</button>
				</form>
			</div>
		</div>
		...
		<div class="data-tables datatable-dark">
			<table class="table table-bordered" id="dataTable2" width="100%" cellspacing="0">
				...
				<tbody>
					<?php $i=1; foreach($keluar as $data): ?>
					<tr>
						<td><?= $i++; ?></td>
